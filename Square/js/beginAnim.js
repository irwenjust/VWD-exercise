...
//		AnimPY.push(this.y);
		...
		if(this.y+this.len>canHeight*0.35&&this.x+this.len*0.5<canWidth*0.5+120&&this.x+this.len*0.5>canWidth*0.5-120){
			this.jump();
			$("#game_title").html("square&nbsp;<i style='font-size: 46px;color:#FF6688;'>J&nbsp;</i>ump");
		}
